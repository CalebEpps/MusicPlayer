...
public class ITookABreakHeresIronMan {
    /*
    Iron Man Script - Dialogue Transcript
Voila! Finally, the Iron Man script is here for all you fans of the Robert Downey Jr. comic book movie. This puppy is a transcript that was painstakingly transcribed using the screenplay and/or viewings of the movie to get the dialogue. I know, I know, I still need to get the cast names in there and all that jazz, so if you have any corrections, feel free to drop me a line. At least you'll have some Iron Man quotes (or even a monologue or two) to annoy your coworkers with in the meantime, right?
